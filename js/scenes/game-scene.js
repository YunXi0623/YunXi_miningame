...
class GameScene {
  constructor(game) {
    ...
    if (typeof wx !== 'undefined' && wx.createImage) {
      ...
      this._backgroundImg.src = 'images/background.png';
    }
    ...
    if (typeof wx !== 'undefined' && wx.createImage) {
      ...
      this._monsterImg.src = 'images/monster.png';
    }
    ...
    if (typeof wx !== 'undefined' && wx.createImage) {
      ...
      this.gestureImage.src = 'images/gesture.png';
    }
  ...
  drawRopes(ctx) {
    ...
    this.ropes.forEach((rope, index) => {
      ...
      if (isVerticalCut) {
        ...
        // 沿着绳子路径添加短线条纹理
        const segments = isSpecialRope ? 8 : 12; // 特殊绳子使用更少的纹理线条，减少计算量
