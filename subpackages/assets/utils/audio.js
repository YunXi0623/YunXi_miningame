...
class AudioManager {
  ...
  loadSounds() {
    ...
    this.sounds.cut.src = 'subpackages/assets/audio/cut.mp3';

    // 碰撞音效
    this.sounds.collision = wx.createInnerAudioContext();
    this.sounds.collision.src = 'subpackages/assets/audio/collision.mp3';

    // 按钮音效
    this.sounds.button = wx.createInnerAudioContext();
    this.sounds.button.src = 'subpackages/assets/audio/button.mp3';

    // 成功音效
    this.sounds.success = wx.createInnerAudioContext();
    this.sounds.success.src = 'subpackages/assets/audio/success.mp3';

    // 失败音效
    this.sounds.fail = wx.createInnerAudioContext();
    this.sounds.fail.src = 'subpackages/assets/audio/fail.mp3';

    // 主界面音乐
    this.music.main = wx.createInnerAudioContext();
    this.music.main.src = 'subpackages/assets/audio/game_main_interface.mp3';
    this.music.main.loop = true;

    // 关卡中音乐
    this.music.game = wx.createInnerAudioContext();
    this.music.game.src = 'subpackages/assets/audio/game_bgm.mp3';
